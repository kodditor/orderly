		...
		<>
			...
			<main className="w-full h-[100%-4rem]">
				<section className="flex bg-peach flex-col gap-4 justify-center py-6 md:py-16 w-[100%] px-[5%] md:px-[10%]  items-center">
					<h1 className="text-3xl md:text-6xl text-center font-black w-[80%] md:w-[55%] text-darkRed">Discover the easiest way to sell online</h1>
				...
				<section className="flex flex-col-reverse md:flex-row gap-4 py-16 w-[100%] px-[5%] md:px-[10%] m-auto justify-center items-center">
					<div className="w-full md:w-1/2 flex gap-8 flex-col">
						<div>
							...
							<h1 className="text-darkRed leading-snug md:leading-normal text-4xl mt-4 mb-4 font-extrabold text-center md:text-left">Experience the Convenience of Setting Up Your Digital Storefront</h1>
						...
						<div className="flex flex-col md:flex-row gap-8">
							<div>
								...
								<h3 className="text-red text-2xl md:text-xl font-bold mb-2 mt-2 text-center md:text-left" >Easy Setup</h3>
							...
							<div>
								...
								<h3 className="text-red text-2xl md:text-xl font-bold text-center mb-2 mt-2 md:text-left" >Efficient Orders</h3>
				...
				<section className="flex flex-col bg-peach md:flex-row gap-4 md:gap-16 py-16 w-[100%] px-[5%] md:px-[10%] m-auto justify-center items-center">
					...
					<div className="w-full md:w-1/2 flex gap-8 flex-col">
						<div className="w-full">
							...
							<h1 className="text-darkRed leading-snug md:leading-normal text-4xl mt-4 mb-4 font-extrabold text-center md:text-left">List and sell your products online</h1>
						...
						<div className="flex flex-col md:flex-row gap-8">
							...
							<div>
								...
								<h3 className="text-red text-2xl md:text-xl font-bold text-center mb-2 mt-2 md:text-left" >Secure Payments</h3>
				...
				<section className="bg-peach py-16 w-[100%] px-[5%] md:px-[10%] m-auto">
					...
					<h1 className="text-darkRed leading-snug md:leading-normal text-4xl mt-4 mb-16 font-extrabold text-center">Effortless setup for expanding your market reach</h1>
					<div className="w-full flex flex-col md:flex-row gap-16 md:gap-8 mb-8">
						<div className="w-full md:w-1/3">
							...
							<h1 className="text-red leading-snug md:leading-normal text-2xl mt-4 mb-4 font-extrabold text-center">Dedicated support for your business growth</h1>
						...
						<div className="w-full md:w-1/3">
							...
							<h1 className="text-red leading-snug md:leading-normal text-2xl mt-4 mb-4 font-extrabold text-center">Streamlined order management and fulfillment</h1>
						...
						<div className="w-full md:w-1/3">
							...
							<h1 className="text-red leading-snug md:leading-normal text-2xl mt-4 mb-4 font-extrabold text-center">Secure and reliable online payment processing</h1>
