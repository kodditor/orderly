  ...
  return (
    <>
      ...
      <main className="w-screen h-[100%-4rem] pt-16 flex flex-col gap-8 justify-center items-center">
        <h1 className="text-3xl md:text-5xl text-center font-black w-[80%] md:w-[55%]">Join hundreds of Ghanaian businesses elevating their online ordering experience with Orderly.</h1>
