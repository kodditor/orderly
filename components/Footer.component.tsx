...
export default function Footer(){
    ...
    return (
        <>
            <footer className="flex items-center justify-between p-5 z-50 relative bg-black w-[100%]">
                <div><Image src={'/img/logo-white.png'} width={150} height={30} alt="The Orderly Logo" /> </div>
                <div className="flex gap-4 items-center">
                    <p className="text-center text-white pr-5 border-r-white border-r-[1.5px]">Orderly Ghana &copy; {today.getFullYear()}</p>
                    <div className="flex gap-4 items-center">
