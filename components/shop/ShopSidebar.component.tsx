...
export default function ShopSideBar({ showCart, setShowCart, cart }: 
    ...
    if(shop.name == ''){
        return (
            <>
                <aside  className="hidden md:block z-30 fixed p-5 pt-8 bg-white w-[20vw] xl:w-[15vw] min-w-[240px] h-[calc(100%-72px)] md:top-[63px] min-h-[500px] border-r-2 border-grey-200 overflow-auto ">
        ...
        return (
            <>
                <aside  className="block md:fixed p-4 md:p-5 md:pt-8 md:pb-2 z-30 bg-white w-full md:w-[20vw] xl:w-[15vw] md:min-w-[240px] md:h-[calc(100%-60px)] md:top-[63px] md:min-h-[500px] border-b-2 md:border-r-2 border-grey-200 overflow-auto ">
